              ...
              <div class="box box-primary">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Inicio: (aa-mm-dd)</label>
                        <input type="text" class="form-control" id="obj" name="ini" value="<?php echo $contrato->inicio; ?>" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">Fin: (aa-mm-dd)</label>
                      <input type="text" class="form-control" id="super" name="fin" value="<?php echo $contrato->fin; ?>">
                    </div>
                  </div>  
                </div>
            ...
            <!-- form start -->
              <div class="box-body">
                <div class="form-group">
                  ...
                  <label for="obj">Objeto crt:</label>
